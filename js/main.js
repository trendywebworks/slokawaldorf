...
$(document).ready(function () {
    ...
    $('.accordion-style2 .collapse').on('show.bs.collapse', function () {
        var id = $(this).attr('id');
        $('a[href="#' + id + '"]').closest('.panel-heading').addClass('active-accordion');
        $('a[href="#' + id + '"] .panel-title').find('i').addClass('fa-caret-down').removeClass('fa-caret-right');
    });

    $('.accordion-style2 .collapse').on('hide.bs.collapse', function () {
        var id = $(this).attr('id');
        $('a[href="#' + id + '"]').closest('.panel-heading').removeClass('active-accordion');
        $('a[href="#' + id + '"] .panel-title').find('i').removeClass('fa-caret-down').addClass('fa-caret-right');
    });
...
const navSlide2 = () => {
  const burger = document.querySelector(".MenuButn");
  const nav = document.querySelector(".SlokaMenuK"); 

  burger.addEventListener("click", () => {
    nav.classList.toggle("SlokaMenuK-bg");
