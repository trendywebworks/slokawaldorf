<?php 
  if(isset($_POST['email'])){
	...
	<tr>
	<td colspan='2' align='left' valign='top'><img style=' margin-top: 15px; ' src='https://slokawaldorf.org/wp-content/themes/sloka/images/apple-touch-icon-114x114.png' width='100'></td>
	</tr>
	<tr>
...
$headers .= 'From: <'.$from.'>' . "\r\n";
   ...
   {
	   //Success Message
       echo "<script type='text/javascript'>  window.location='https://slokawaldorf.org/thank-you/'; </script>";
   }
   else
   {	
   	 //Fail Message
